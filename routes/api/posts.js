...
router.get("/", async (req, res, next) => {
    ...
    if(searchObj.isReply !== undefined){  //to not see the replies on posts tab
        var isReply = searchObj.isReply == "true";
        searchObj.replyTo =  {$exists: isReply}
        delete searchObj.isReply; //this is how to delete prop from js object
        // console.log(searchObj);
    }
    if(searchObj.search !==undefined){
        searchObj.content = {$regex: searchObj.search, $options: "i"} //i mean case sensetive
